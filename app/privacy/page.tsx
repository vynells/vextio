    ...
    <main className="mx-auto max-w-[720px] px-6 py-20 md:px-10">
      ...
      <div className="space-y-8 text-[14px] font-light leading-[1.8] text-muted">
        <p>
          ...
          you use our website and place an order, and how we use it.
        </p>
        ...
        <section>
          ...
          <p>
            ...
            phone number, delivery address, and payment details necessary to
            process your order. Payment details entered on our checkout page
            are handled directly by our payment processor and are not stored
            on our servers.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            order, communicate with you about your order status, and respond
            to customer support requests. We do not sell your personal
        ...
        <section>
          ...
          <p>
            ...
            complete payment) and courier partners (to deliver your order).
            These parties only receive the information necessary to perform
            their service.
          </p>
        </section>
