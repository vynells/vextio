      ...
      <main className="mx-auto max-w-[720px] px-6 py-20 md:px-10">
        ...
        <div className="space-y-8 text-[14px] font-light leading-[1.8] text-muted">
          <section>
            ...
            <p>
              ...
              <strong className="text-brown">
                only within 5 calendar days
              </strong>{" "}
              of the delivery date. Requests made after this window will not
              be accepted under any circumstances, regardless of reason.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Once a returned item is received and inspected, approved
              refunds are processed to the original payment method within
              7–10 business days. Cash on Delivery orders are refunded via
              bank transfer or Easypaisa.
            </p>
          </section>
        </div>
